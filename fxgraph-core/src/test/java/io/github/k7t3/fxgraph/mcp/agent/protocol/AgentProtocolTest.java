...
/**
 * Tests for the AgentCommand and AgentResponse protocol classes in the {@code core} module.
 * Verifies JSON serialization/deserialization round-trip behavior for the authoritative
 * copies used by both the CLI and MCP server.
 */
class AgentProtocolTest {
    ...
    @Test
    void commandDefaultConstructorAndSetters() {
    ...
    void successResponseSerialization() throws Exception {
        ...
        // error is null, should be excluded by @JsonInclude(NON_NULL)
    ...
    void lineDelimitedProtocol() throws Exception {
        ...
        // No embedded newlines — required for the line-delimited TCP protocol
        ...
        // Both are parseable from a single line
